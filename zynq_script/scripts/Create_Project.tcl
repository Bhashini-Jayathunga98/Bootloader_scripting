...
# ----------------------------------------------------------------------
set current_project_dir "/home/bhashini/Desktop/Bootloader_Scripting/Scripting/zynq_script"
...
set output_files "$current_project_dir/output/vivado"
...
# ----------------------------------------------------------------------
#set_property pfm_name {} [get_files -all {"$current_project_dir/workdir/Calisto_P2/Calisto_P2.srcs/sources_1/bd/design_1/design_1.bd"}]
write_hw_platform -fixed -include_bit -force -file "$output_files/design_1_wrapper.xsa"
puts ".bin file created successfully at: $output_files/design_1_wrapper.xsa"
