...
proc cr_bd_design_2 { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__ACT_DDR_FREQ_MHZ {600.000000} \
   ...
   CONFIG.PSU__CRF_APB__DDR_CTRL__ACT_FREQMHZ {300.000000} \
