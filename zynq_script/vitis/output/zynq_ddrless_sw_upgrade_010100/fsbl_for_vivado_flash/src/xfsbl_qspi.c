...
int UnProtectFlash() {
	...
	XFsbl_Printf(DEBUG_PRINT_ALWAYS, "Un-protect all flash sectors.\n\r");
	...
	FlashStatus[0] = FlashStatus[1] & ~FLASH_UNPROTECT_MASK;

	XFsbl_Printf(DEBUG_PRINT_ALWAYS, "Write 0x%lX to status register.\n\r", FlashStatus[0]);

	XQspiPsu_WriteProtectToggle(&QspiPsuInstance, 1);
