...
src/%.o: ../src/%.c
	...
	aarch64-none-elf-gcc -DARMA53_64 -Wall -O0 -g3 -c -fmessage-length=0 -MT"$@" -Os -flto -ffat-lto-objects -I/home/bhashini/Desktop/Bootloader_Scripting/Scripting/zynq_script/vitis/output/zynq_ddrless_sw_upgrade_010100/design_1_wrapper_010200_1/export/design_1_wrapper_010200_1/sw/design_1_wrapper_010200_1/domain_psu_cortexa53_0/bspinclude/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
