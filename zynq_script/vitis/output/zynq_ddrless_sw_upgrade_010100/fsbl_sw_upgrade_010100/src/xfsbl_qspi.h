...
#define ADDRESS_1_OFFSET	(1U) /* MSB byte of address to read fr write */
...
/* Top 2047:1536 sector protected. Status register write disabled. */
#define GOLDEN_PROTECT_MASK 	0xC8
